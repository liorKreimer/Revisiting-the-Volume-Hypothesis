...
def main():
    ...
    while True:        
        ...
        if walker.it%save_every ==0:            
            ...
            os.system(f'cp -r {os.environ["WLRESULTS"]} {os.environ["HOME"]}/rewl_Project/')
            print(f"Rank {rank}: Copied results to {os.environ['HOME']}/rewl_Project/results/ at iteration {it}")
