...
def main():
    ...
    while True:
        ...
        if walker.it % save_every == 0:
            ...
            os.system(f'cp -r {os.environ["WLRESULTS"]} {os.environ["HOME"]}/rewl_sim_B/')
            print(f"Rank {rank}: Copied results to {os.environ['HOME']}/rewl_sim_B/results/ at iteration {it}")
